...
public static class PlanetoidMap
{
    ...
    private const double ArcticLatitude = DoubleConstants.HalfPi - ArcticLatitudeRange;
    ...
    public static double GetPrecipitationAt(
        ...
        Image<L16> precipitationMap,
        Vector3 position,
        MapProjectionOptions? options = null) => planet.GetPrecipitationAt(
            precipitationMap,
            planet.VectorToLatitude(position),
            planet.VectorToLongitude(position),
            options);
    ...
    public static double GetSnowfallAt(
        ...
        Image<L16> snowfallMap,
        Vector3 position,
        MapProjectionOptions? options = null) => planet.GetSnowfallAt(
            snowfallMap,
            planet.VectorToLatitude(position),
            planet.VectorToLongitude(position),
            options);
    ...
    private static double GetElevationNoise(FastNoise noise1, FastNoise noise2, FastNoise noise3, Vector3<double> position)
