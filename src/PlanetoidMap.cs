...
namespace Tavenem.Universe.Maps
{
    ...
    public static class PlanetoidMap
    {
        ...
        private static double GetElevationNoise(FastNoise noise1, FastNoise noise2, FastNoise noise3, Mathematics.Doubles.Vector3 position)
        ...
        private static double GetPrecipitationNoise(
            ...
            FastNoise noise1,
            FastNoise noise2,
            Mathematics.Doubles.Vector3 position,
            double latitude,
            double seasonalLatitude,
            double temperature,
            out double snow)
