...
namespace Tavenem.Universe.Maps
{
    ...
    public static class SurfaceMap
    {
        ...
        internal static HugeNumber GetAreaOfPointFromRadiusSquared(
            HugeNumber radiusSquared,
            int x, int y,
            int xResolution,
            int yResolution,
        ...
        internal static double GetScale(int resolution, double? range = null, bool equalArea = false)
        {
            if (equalArea)
            {
                return range < Math.PI && !range.Value.IsNearlyZero()
                    ...
                    : DoubleConstants.PISquared / resolution;
            }
            else
            {
                return range < Math.PI && !range.Value.IsNearlyZero()
        ...
        internal static HugeNumber GetSeparationOfPointFromRadiusSquared(
            HugeNumber radiusSquared,
            int x, int y,
            int resolution,
            MapProjectionOptions options)
